...
public class MainActivity2 extends AppCompatActivity implements CallBackItemTouch, SwipeRefreshLayout.OnRefreshListener{
                    ...
                    myRef.child("allTables").get().addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
                        ...
                        public void onComplete(@NonNull Task<DataSnapshot> task) {
                            if (!task.isSuccessful()) {
                                ...
                                Toast.makeText(MainActivity2.this, "¡El expense ha sido creado con éxito!", Toast.LENGTH_SHORT).show();
    ...
    public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
        ...
        MaterialAlertDialogBuilder dialog = new MaterialAlertDialogBuilder(MainActivity2.this);
                ...
                myRef.child("allTables").get().addOnCompleteListener(new OnCompleteListener<DataSnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<DataSnapshot> task) {
                        if (!task.isSuccessful()) {
                            ...
                            Toast.makeText(MainActivity2.this, "El reporte se ha eliminado", Toast.LENGTH_SHORT).show();
                            Log.d("firebase", String.valueOf(task.getResult().getValue()));
                        }
                    }
                });
    ...
    private void loadReportsFromArrayList() {
        if(!HCardDB.isEmpty()) {
            ...
            adapter = new HCardsViewAdapter(MainActivity2.this);
            adapter.setCards(hCards);
            homeRecycler.setAdapter(adapter);
            homeRecycler.setLayoutManager(new LinearLayoutManager(MainActivity2.this));
        }
        else {
            TextView txtEmpty = new TextView(MainActivity2.this);
